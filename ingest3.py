...
resources = {
    ...
    DocType.WEB: [
        # "https://www.ameli.fr/paris/assure/remboursements",
        # "https://www.ameli.fr/paris/assure/droits-demarches",
        # *["https://www.cnmss.fr/faq?page=" + str(i) for i in range(0, 10)],
...
class ChromaEmbedding:
    ...
    def __init__(self, model_name: str,
        ...
        self.documents = ChromaEmbedding._loadDocuments("/home/eudes/workspace/pocLLM/toto.pdf", splitter)
        # print("document ====> "+str(self.documents))
    ...
    @staticmethod
    def _loadDocuments(documents: str, splitter: TextSplitter):
        import itertools
        loading_doc: list[Document] = []
        pdf = ChromaEmbedding.load_pdf_using_layout_lm(documents)
